...
LOCAL_COMMANDS = [
    ...
    # NMI Watchdog
    {
        "keywords": ["enable", "nmi", "watchdog"],
        "description": "Enable NMI watchdog (runtime + persistent)",
        "category": "kernel",
        "commands": [
        ...
        "risk_level": "medium",
        "requires_reboot": False,
        "notes": "NMI watchdog detects hard lockups. May increase power consumption slightly.",
    },
    {
        "keywords": ["disable", "nmi", "watchdog"],
        "description": "Disable NMI watchdog (runtime + persistent)",
        "category": "kernel",
        "commands": [
        ...
        "risk_level": "medium",
        "requires_reboot": False,
        "notes": "Disabling NMI watchdog reduces CPU overhead and power usage but removes hard lockup detection.",
    },
    {
        "keywords": ["check", "nmi", "watchdog", "status"],
        "description": "Check NMI watchdog status",
        "category": "kernel",
        "commands": [
    ...
    {
        "keywords": ["enable", "unknown", "nmi", "panic"],
        "description": "Enable panic on unknown NMI (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.unknown_nmi_panic=1",
            "echo 'kernel.unknown_nmi_panic = 1' >> /etc/sysctl.d/99-nmi.conf",
        ],
        "risk_level": "high",
        "requires_reboot": False,
        "notes": "WARNING: System will panic/crash on unknown NMI. Useful with kdump for debugging.",
    },
    {
        "keywords": ["disable", "unknown", "nmi", "panic"],
        "description": "Disable panic on unknown NMI (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.unknown_nmi_panic=0",
            "echo 'kernel.unknown_nmi_panic = 0' >> /etc/sysctl.d/99-nmi.conf",
        ],
        "risk_level": "medium",
        "requires_reboot": False,
        "notes": "",
    ...
    {
        "keywords": ["enable", "panic", "unrecovered", "nmi"],
        "description": "Enable panic on unrecovered NMI (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.panic_on_unrecovered_nmi=1",
            "echo 'kernel.panic_on_unrecovered_nmi = 1' >> /etc/sysctl.d/99-nmi.conf",
        ],
        "risk_level": "high",
        "requires_reboot": False,
        "notes": "WARNING: System will panic on unrecovered NMI (e.g. memory errors).",
    },
    {
        "keywords": ["disable", "panic", "unrecovered", "nmi"],
        "description": "Disable panic on unrecovered NMI (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.panic_on_unrecovered_nmi=0",
            "echo 'kernel.panic_on_unrecovered_nmi = 0' >> /etc/sysctl.d/99-nmi.conf",
        ],
        "risk_level": "medium",
        "requires_reboot": False,
        "notes": "",
    ...
    {
        "keywords": ["enable", "panic", "io", "nmi"],
        "description": "Enable panic on I/O NMI (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.panic_on_io_nmi=1",
            "echo 'kernel.panic_on_io_nmi = 1' >> /etc/sysctl.d/99-nmi.conf",
        ],
        "risk_level": "high",
        "requires_reboot": False,
        "notes": "WARNING: System will panic on I/O NMI errors. Useful with kdump for debugging I/O issues.",
    },
    {
        "keywords": ["disable", "panic", "io", "nmi"],
        "description": "Disable panic on I/O NMI (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.panic_on_io_nmi=0",
            "echo 'kernel.panic_on_io_nmi = 0' >> /etc/sysctl.d/99-nmi.conf",
        ],
        "risk_level": "medium",
        "requires_reboot": False,
        "notes": "",
    ...
    {
        "keywords": ["enable", "all", "nmi", "panic"],
        "description": "Enable all NMI panic settings (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.unknown_nmi_panic=1",
            "sysctl -w kernel.panic_on_io_nmi=1",
        ...
        "risk_level": "high",
        "requires_reboot": False,
        "notes": "WARNING: System will panic on any NMI event. Ensure kdump is configured to capture crash dumps.",
    },
    {
        "keywords": ["disable", "all", "nmi", "panic"],
        "description": "Disable all NMI panic settings (runtime + persistent)",
        "category": "kernel",
        "commands": [
            "sysctl -w kernel.unknown_nmi_panic=0",
            "sysctl -w kernel.panic_on_io_nmi=0",
    ...
    {
        "keywords": ["check", "nmi", "panic", "settings"],
        "description": "Check all NMI-related kernel settings",
        "category": "kernel",
        "commands": [
            "sysctl kernel.nmi_watchdog",
            "sysctl kernel.unknown_nmi_panic",
            "sysctl kernel.panic_on_io_nmi",
            "sysctl kernel.panic_on_unrecovered_nmi",
        ],
        "risk_level": "low",
        "requires_reboot": False,
        "notes": "",
